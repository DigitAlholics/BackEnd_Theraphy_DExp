Feature: User Adding
  ...
  Scenario: Add User with existing Email
    Given An User Resource with values "jhon@email.com", "jhon12", "patient" is already stored
    When A Post Request is sent with values "jhon@email.com", "jhon12", "patient"
